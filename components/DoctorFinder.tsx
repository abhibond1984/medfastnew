                    ...
                    <div className="p-8">
                      ...
                      {data.phone && (
                        <div className="flex items-center gap-2 mt-4">
                          ...
                          <a 
                            href={`tel:${data.phone}`} 
                            className={`text-sm font-semibold ${theme === 'dark' ? 'text-slate-300 hover:text-white' : 'text-slate-700 hover:text-slate-900'}`}
                          >
                            {data.phone}
                          </a>
                        </div>
                      ...
                      {data.address && (
                        <div className="flex items-start gap-2 mt-2">
                          <svg className={`w-5 h-5 flex-shrink-0 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                          <p className={`text-sm ${theme === 'dark' ? 'text-slate-300' : 'text-slate-700'}`}>{data.address}</p>
                        </div>
                      )}

                      <div className="text-[10px] font-black text-brand-cyan uppercase tracking-widest flex items-center gap-2 mt-4">
