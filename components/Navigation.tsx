  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] p-6 pointer-events-none">
      <div className="max-w-7xl mx-auto flex justify-between items-center pointer-events-auto">
        ...
        >
          <div className="w-9 h-9 bg-gradient-to-tr from-brand-rose via-brand-indigo to-brand-cyan rounded-full flex items-center justify-center text-white font-black text-[10px] shadow-lg shadow-indigo-500/30 group-hover:rotate-45 transition-transform duration-500">MF</div>
        ...
        <div className="flex gap-4">
          <button 
            ...
            className={`glass-vibrant p-3 rounded-full flex items-center justify-center transition-all hover:scale-110 shadow-xl`}
            title={`Switch to ${theme === 'dark' ? 'light' : 'dark'} mode`}
          >
            {theme === 'dark' ? (
              <svg className="w-5 h-5 text-yellow-300 drop-shadow-[0_0_8px_rgba(253,224,71,0.6)]" fill="currentColor" viewBox="0 0 20 20"><path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-13a1 1 0 10-2 0V3a1 1 0 102 0v2zm4 2a1 1 0 00-1 1v1a1 1 0 102 0V8a1 1 0 00-1-1zm3 3a1 1 0 100-2h-2a1 1 0 100 2h2zm-3 4a1 1 0 11-1-1 1 1 0 011 1zm-5 3a1 1 0 10-2 0v2a1 1 0 102 0v-2zm-4-2a1 1 0 11-1 1 1 1 0 011-1zm-3-3a1 1 0 100-2h2a1 1 0 100 2H3z" clipRule="evenodd"/></svg>
            ) : (
